...
export const metadata: Metadata = {
  title: "HireScope",
  description: "Resume-grounded AI interviews with a searchable, evidence-backed talent pool.",
};
    ...
    <html lang="en">
      <body className="min-h-screen">
        ...
        <footer className="mx-auto max-w-6xl px-6 py-10 text-xs text-[var(--ink-faint)]">
          Assessments are decision support, not decisions. Every score is reviewable, every
          candidate can see and contest their own report.
        </footer>
      </body>
    </html>
  );
